...
<div class="relative bg-white overflow-hidden">
      ...
      <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
        <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start">
          <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
            <div class="flex items-center justify-between w-full md:w-auto">
              <a href="#" aria-label="Home">
                <img class="h-8 w-auto sm:h-16" src="/img/cargopanda_logo_without_text.svg" alt="Logo">
              </a>
          ...
          <div class="hidden md:block md:ml-10 md:pr-4">
            ...
            <a href="#" class="ml-8 font-medium text-gray-500 hover:text-gray-900 transition duration-150 ease-in-out">Sign up</a>
        ...
        <div class="rounded-lg shadow-md">
          <div class="rounded-lg bg-white shadow-xs overflow-hidden" role="menu" aria-orientation="vertical" aria-labelledby="main-menu">
            <div class="px-5 pt-4 flex items-center justify-between">
              <div>
                <img class="h-16 w-auto" src="/img/cargopanda_logo_without_text.svg" alt="">
              </div>
              <div class="-mr-2">
      ...
      <main class="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
        <div class="sm:text-center lg:text-left">
          <h2 class="text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">
            <span class="text-indigo-600">Cargo Panda</span> helps to control your
            <br class="xl:hidden">
            <span class="text-indigo-900">transport business</span>
          </h2>
  ...
  <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
    <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="https://images.unsplash.com/photo-1485575301924-6891ef935dcd?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2550&q=80" alt="">
  </div>
</div>
<x-frontpage-features></x-frontpage-features>
<x-frontpage-pricing-tables></x-frontpage-pricing-tables>
<x-frontpage-testimonials></x-testimonials>
<x-frontpage-contact-us></x-frontpage.contact-us>
<x-frontpage-footer></x-frontpage-footer>
@endsection
