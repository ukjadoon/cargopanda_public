<div>
    <div wire:ignore>
        <img id="document" class="min-w-full w-1/2"
            src="{{ route('admin-show-truck-doc-source', ['documentId' => $documentId, 'truckId' => $truckId]) }}"
            data-zoom="{{ route('admin-show-truck-doc-source', ['documentId' => $documentId, 'truckId' => $truckId]) }}" />
        <p id="detail"></p>
    </div>
