  ...
  <div class="relative max-w-screen-xl mx-auto pt-20 pb-12 px-4 sm:px-6 lg:px-8 lg:py-20">
    ...
    <div class="relative lg:flex lg:items-center">
      <div class="hidden lg:block lg:flex-shrink-0">
        <img class="h-64 w-64 rounded-full xl:h-80 xl:w-80" src="/img/marian_profile.jpeg" alt="">
      </div>
          ...
          <footer class="mt-8">
            <div class="flex">
              <div class="flex-shrink-0 lg:hidden">
                <img class="h-12 w-12 rounded-full" src="/img/marian_profile.jpeg" alt="">
              </div>
              <div class="ml-4 lg:ml-0">
                <div class="text-base leading-6 font-medium text-gray-900">Marian</div>
                <div class="text-base leading-6 font-medium text-indigo-600">CEO, Cargo Module</div>
              </div>
            </div>
          </footer>
        </blockquote>
