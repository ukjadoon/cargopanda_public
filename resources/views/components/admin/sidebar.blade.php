<x-common.sidebar>
    ...
    <nav class="flex-1 px-2 bg-white">
        <a href="{{ route('admin-dashboard') }}"
            class="group flex items-center px-2 py-2 text-sm leading-5 font-medium {{ request()->routeIs('admin-dashboard') ? 'text-gray-900 bg-gray-100 hover:bg-gray-100 focus:bg-gray-200' : 'text-gray-600 hover:bg-gray-50 focus:bg-gray-100' }} rounded-md hover:text-gray-900 focus:outline-none transition ease-in-out duration-150">
        ...
        <a href="{{ route('admin-checklist') }}"
            class="group flex items-center px-2 py-2 text-sm leading-5 font-medium {{ request()->routeIs('admin-checklist') ? 'text-gray-900 bg-gray-100 hover:bg-gray-100 focus:bg-gray-200' : 'text-gray-600 hover:bg-gray-50 focus:bg-gray-100' }} rounded-md hover:text-gray-900 focus:outline-none transition ease-in-out duration-150">
        ...
        <a href="{{ route('admin-organization-documentation') }}"
            class="group flex items-center px-2 py-2 text-sm leading-5 font-medium {{ request()->routeIs('admin-organization-documentation') ? 'text-gray-900 bg-gray-100 hover:bg-gray-100 focus:bg-gray-200' : 'text-gray-600 hover:bg-gray-50 focus:bg-gray-100' }} rounded-md hover:text-gray-900 focus:outline-none transition ease-in-out duration-150">
        ...
        <a href="{{ route('admin-truck-documentation') }}"
            class="group flex items-center px-2 py-2 text-sm leading-5 font-medium {{ request()->routeIs('admin-truck-documentation') ? 'text-gray-900 bg-gray-100 hover:bg-gray-100 focus:bg-gray-200' : 'text-gray-600 hover:bg-gray-50 focus:bg-gray-100' }} rounded-md hover:text-gray-900 focus:outline-none transition ease-in-out duration-150">
            <svg class="mr-4 h-6 w-6 text-gray-400 group-hover:text-gray-500 group-focus:text-gray-500 transition ease-in-out duration-150"
                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
